...
fn root_scalar() {
    ...
    let fun = Rc::new(|x: f64| 4.0 * x.powi(3) - 12.0 * x.powi(2) + 3.0 * x - 9.0);
    let dfun = Rc::new(|x: f64| 12.0 * x.powi(2) - 24.0 * x + 3.0);
    let ddfun = Rc::new(|x: f64| 24.0 * x - 24.0);
    let x0 = 10.0;
    let x1 = -50.0;
    ...
    let fun = Rc::new(|z: Complex64| 2.0 * z.powi(3) - 10.0 * z.powi(2) + 3.0 * z - 15.0);
    let dfun = Rc::new(|z: Complex64| 6.0 * z.powi(2) - 20.0 * z + 3.0);
    let ddfun = Rc::new(|z: Complex64| 12.0 * z - 20.0);
